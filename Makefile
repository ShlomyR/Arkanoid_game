...
$(TARGET): $(OBJECTS) $(HEDER_DIR_SRC)/*.hpp $(HEDER_DIR_COMMANDS)/*.hpp $(HEDER_DIR_PARSER)/*.hpp $(HEDER_DIR_INTERFACES)/*.hxx $(HEDER_DIR_INPUT_LOGIC)/*.hpp $(HEDER_DIR_MENU)/*.hpp $(HEDER_DIR_PLAYER_INTERACTIV_OBJ)/*.hpp $(HEDER_DIR_SCORE_LOGIC)/*.hpp
...
.PHONY: clean
clean:
	-rm -rf $(BUILD_DIR_SRC) $(BUILD_DIR_COMMANDS) $(BUILD_DIR_PARSER) $(BUILD_DIR_INPUT_LOGIC) $(BUILD_DIR_MENU) $(BUILD_DIR_PLAYER_INTERACTIV_OBJ) $(BUILD_DIR_SCORE_LOGIC) $(TARGET)
