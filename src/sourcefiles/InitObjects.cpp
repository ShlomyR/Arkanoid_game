...
InitObjects::InitObjects(sf::Vector2u windowSize, std::string windowTitle, int startingLives, int startingLevel, int maxLevel)
    ...
    , m_renderer(std::make_unique<RendererImpl>(m_window, m_gameState, m_menu, m_options, m_difficulty, m_video, m_physicsManager, m_hud, m_paddle, m_ball, m_brick, m_border, m_background, m_controlSettingsMenu, m_volumeManager))
