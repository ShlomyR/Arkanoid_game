// #include "KeyboardControlHandler.hpp"


// void KeyboardControlHandler::handleInput(sf::Event event, sf::Vector2f& mousePosition) {
//     if (event.type == sf::Event::MouseMoved) {
//         handleMouseMovedInput(mousePosition);
//     } else if (event.type == sf::Event::KeyPressed) {
//         handleKeyPressedInput(event, mousePosition);
//     }
// }

// void KeyboardControlHandler::update(const sf::Vector2u& windowSize) {
//     updateText(windowSize);
// }

// void KeyboardControlHandler::draw() {
...
// std::string KeyboardControlHandler::removeLastCharacter(const std::string& input) {
//     if (input.empty()) {
//         return "";
//     } else {
...
// void KeyboardControlHandler::makeText(sf::Text& text, sf::Font& font, std::string str, sf::Vector2i vec2i) {
//     text.setFont(font);
...
// ControlSettings& KeyboardControlHandler::getControlSettings()
// {
//     return m_controlSettings;
// }

// void KeyboardControlHandler::initializeGUI()
// {
...
// void KeyboardControlHandler::updateText(const sf::Vector2u &)
// {
...
// void KeyboardControlHandler::handleMouseMovedInput(sf::Vector2f& mousePosition)
// {
...
// void KeyboardControlHandler::handleKeyPressedInput(const sf::Event& event, sf::Vector2f& mousePosition)
// {
//     for (auto& controlText : m_controlTexts) {
//         if (controlText.second->getGlobalBounds().contains(mousePosition)) {
...
//                 std::variant<sf::Keyboard::Key, int> mapping = m_controlSettings.getMapping(existingText.first);
//                 if (existingText.first != controlText.first && std::get<sf::Keyboard::Key>(mapping) == pressedKey) {
...
// void KeyboardControlHandler::updateControlText(const std::string& control) {
...
//     if (text) {
//         std::variant<sf::Keyboard::Key, int> mapping = m_controlSettings.getMapping(control);
//         sf::Keyboard::Key key = std::get<sf::Keyboard::Key>(mapping);
...
// std::string KeyboardControlHandler::keyToString(sf::Keyboard::Key key) {
